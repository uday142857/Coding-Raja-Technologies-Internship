...
def main():
    print(f"Runnaing expense traker!")
    ...
    save_expensse_to_file(expense, expense_file_path)
...
def save_expensse_to_file(expense : Expense, expense_file_path):
    print(f"Save users expense! :{expense} to {expense_file_path}")
    with open(expense_file_path, "a") as f:
        f.write(f"{expense.name}, {expense.amount}, {expense.category}\n")
    

def summerize_expense(expense_file_path, budget):
    print(f"Summerize users expense!")
